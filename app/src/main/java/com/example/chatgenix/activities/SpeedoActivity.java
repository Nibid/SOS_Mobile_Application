...
public class SpeedoActivity extends AppCompatActivity implements LocationListener, TextToSpeech.OnInitListener {//implementing the Interface LocationListener for receiving notifications when the location has changed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor != null){
            ...
            if(cursor.getInt(0) == 0){
                db.execSQL("INSERT INTO POIS VALUES ('Vijaya Vittala Institute of Technology', 'The Vijaya Vittala Institute of Technology is a Institute of Technology located in Bangaluru, India with academic departments focused mainly on Computer Science, Civil, Electrical and Mechanical.','education',37.941770, 23.652772);");
    ...
    public void onInit(int status) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            mTextToSpeech.speak("Speed Violation. You Have Exceed The Speed Limit. Please Slow Down.", TextToSpeech.QUEUE_FLUSH,
                    null);
        }
    }
    ...
    public void statistics(View view){//we go to the statistics menu at the activity2
        startActivity(new Intent(this,SpeedoActivity2.class));
