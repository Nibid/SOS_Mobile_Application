...
public class SpeedoActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speedo2);
        ...
        if (cursor4 != null){
            ...
            if(cursor4.getInt(0) == 0){
                ...
                while (c4.moveToNext()){
                    ...
                    if (title.equals("Vijaya Vittala Institute of Technology"))
                        times[0] +=1;
                }
                int l = 0;
                ...
                if (l==0){
                    SpannableStringBuilder str = new SpannableStringBuilder("-Most visited Point of Interest : " +" is Vijaya Vittala Institute of Technology which was visited "+String.valueOf(times[l])+" times");
                    str.setSpan(new StyleSpan(Typeface.BOLD), 0, "-Most visited Point of Interest : ".length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    textView23.setText(str);
                    button.setText("Show Information");
                    poi = "Vijaya Vittala Institute of Technology";
                }
